...
module.exports = function (wallaby) {
    ...
    return {
        files: [
            ...
            { pattern: "Modules/Cratis.Pipeline/json.js", instrument: false, load: false },
            { pattern: "package.json", instrument: false, load: false },

            { pattern: "Source/Runtime.JavaScript.Specifications/**/given/*.js", load: false },
            { pattern: "Source/Runtime.JavaScript/**/*.js", load: false }
        ],
        tests: [
            { pattern: "!Source/Runtime.JavaScript.Specifications/**/given/*.js", load: false },
            { pattern: "Source/Runtime.JavaScript.Specifications/**/*.js", load: false }
        ],
        ...
        setup: function (wallaby) {
            ...
            System.import("./package.json!./Modules/Cratis.Pipeline/json.js").then(function (pkg) {
                var systemConfig = {
